...
morpho_model_dir = os.path.join(model_dir, f'morpho_feature_lightning_attention_gbr_25_{channel}shallower_liter/')
os.makedirs(morpho_model_dir, exist_ok = True)
morpho_gbr_h5_file = f'morphodynamic_training_data_gbr_25_{channel}.h5'
num_classes = 3
batch_size = 98000
epochs = 100
block_config = (6,12)
