...
print('Goblet', len(tracks_goblet_basal_radial_dataframe['Cell_Type']['Goblet']))
print('Basal', len(tracks_goblet_basal_radial_dataframe['Cell_Type']['Basal']))
print('Radial', len(tracks_goblet_basal_radial_dataframe['Cell_Type']['Radial']))
