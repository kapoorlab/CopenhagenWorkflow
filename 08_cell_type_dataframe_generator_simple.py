...
goblet_cells_file = f'{home_folder}Mari_Data_Oneat/Mari_{dataset_name}_Dataset_Analysis/dual_predicted_attention_morpho_nuclei_membrane_nuclei_morpho_dynamic/goblet_cells_nuclei_annotations.csv'
basal_cells_file = f'{home_folder}Mari_Data_Oneat/Mari_{dataset_name}_Dataset_Analysis/dual_predicted_attention_morpho_nuclei_membrane_nuclei_morpho_dynamic/basal_cells_nuclei_annotations.csv'
radial_cells_file = f'{home_folder}Mari_Data_Oneat/Mari_{dataset_name}_Dataset_Analysis/dual_predicted_attention_morpho_nuclei_membrane_nuclei_morpho_dynamic/radially_intercalating_cells_nuclei_annotations.csv'
