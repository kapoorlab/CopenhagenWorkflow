...
goblet_cells_file = f'{home_folder}Mari_Data_Oneat/Mari_{dataset_name}_Dataset_Analysis/annotations_predicted_attention_tracklet_length_25_t_initial_50_t_final_400_{channel}shallower_liter_morpho_dynamic/goblet_cells_{channel}annotations_inception.csv'
basal_cells_file = f'{home_folder}Mari_Data_Oneat/Mari_{dataset_name}_Dataset_Analysis/annotations_predicted_attention_tracklet_length_25_t_initial_50_t_final_400_{channel}shallower_liter_morpho_dynamic/basal_cells_{channel}annotations_inception.csv'
radial_cells_file = f'{home_folder}Mari_Data_Oneat/Mari_{dataset_name}_Dataset_Analysis/annotations_predicted_attention_tracklet_length_25_t_initial_50_t_final_400_{channel}shallower_liter_morpho_dynamic/radially_intercalating_cells_{channel}annotations_inception.csv'
...
goblet_basal_radial_dataframe = os.path.join(data_frames_dir , f'goblet_basal_dataframe_normalized_{channel}predicted_shallower_liter_morpho_dynamic.csv')
