...
shape_model_dirs_base = [
    "shape_feature_attention_shallower_litest",
    "shape_feature_attention_shallower_liter",
    "shape_feature_attention_shallower_lite",
    "shape_feature_attention_shallower"
]
