...
vision_gbr_h5_files = [
    "vision_training_data_gbr_nuclei_.h5",
]

for i, morpho_model_base in enumerate(gbr_vision_model_dirs):
    input_shape = [10,256,256,8]
