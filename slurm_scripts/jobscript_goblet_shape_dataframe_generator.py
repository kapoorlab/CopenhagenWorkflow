...
for i, shape_model_base in enumerate(shape_model_dirs_base):
    ...
    for j, channel in enumerate(channels):
        ...
        sbatch_command = [
            ...
            "--wrap",
            f"module purge && module load anaconda-py3 && conda deactivate && conda activate capedenv && python /gpfswork/rech/jsy/uzj81mi/CopenhagenWorkflow/08_cell_type_dataframe_generator.py --dataset_name Sixth --model_type shape_only --home_folder /lustre/fsn1/projects/rech/jsy/uzj81mi/ --channel {channel} --model_name {shape_model_base}"
        ]
