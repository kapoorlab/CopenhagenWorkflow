...
dynamic_model_dir = os.path.join(model_dir, 'dynamic_feature_lightning_densenet_mitosis_10/')
os.makedirs(dynamic_model_dir, exist_ok = True)
dynamic_mitosis_h5_file = 'dynamic_training_data_mitosis_10.h5'
...
train_mitosis_neural_net(
    h5_file = os.path.join(base_dir, dynamic_mitosis_h5_file),
    save_path = dynamic_model_dir,
    num_classes = num_classes,
    batch_size = batch_size,
    epochs = epochs,
    model_type = 'densenet',
    experiment_name='dynamic_densenet',
    num_workers = 10,
