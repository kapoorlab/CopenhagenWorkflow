...
save_dir = os.path.join(tracking_directory, f'predicted_attention_shallowest_litest_nuclei_augmented_nuclei_morpho_dynamic_augmented/')
data_frames_dir = os.path.join(tracking_directory, f'dataframes/')

Path(save_dir).mkdir(exist_ok=True, parents=True) 


dataframe_file = os.path.join(data_frames_dir , f'goblet_basal_dataframe_normalized_attention_shallowest_litest_nuclei_augmented_nuclei_morpho_dynamic_augmented.csv')
