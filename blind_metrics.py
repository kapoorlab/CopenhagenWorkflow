...
dataframe_file = os.path.join(data_frames_dir , f'goblet_basal_dataframe_normalized_attention_shallowest_litest_nuclei_balanced_nuclei_morpho_dynamic_balanced.csv')
