...
def main(args):
    ...
    for index, t_initial in enumerate(t_initials):
        ...
        annotations_prediction_dir = f'{home_folder}Mari_Data_Oneat/Mari_{dataset_name}_Dataset_Analysis/annotations_predicted_attention_{model_name}_{channel}shape_only/'
