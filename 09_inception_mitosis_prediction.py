...
mitosis_shape_lightning_model, mitosis_shape_torch_model = LightningModel.extract_mitosis_model(
    DenseNet,
...
mitosis_dynamic_lightning_model, mitosis_dynamic_torch_model = LightningModel.extract_mitosis_model(
    DenseNet,
...
mitosis_shape_torch_model.eval()
mitosis_dynamic_torch_model.eval()
